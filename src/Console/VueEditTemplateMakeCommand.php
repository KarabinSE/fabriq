...
class VueEditTemplateMakeCommand extends GeneratorCommand
{
    /**
     ...
     * @var string
     */
    protected $name = 'make:vue-edit-template';
     ...
     * @var string
     */
    protected $description = 'Creates a Fabriq opinionated Inertia edit page stub from stubs';
     ...
     * @var string
     */
    protected $type = 'VueEditTemplate';
    ...
    protected function alreadyExists($rawName)
    {
        ...
        $path = "{$this->laravel['path']}/../resources/js/inertia/pages/Admin/{$name}/Edit.vue";
    ...
    {
        return __DIR__.'/stubs/vue.edit.component.vue';
    }
    ...
    protected function getPath($name)
    {
        ...
        return "{$this->laravel['path']}/../resources/js/inertia/pages/Admin/{$name}/Edit.vue";
    }
}
